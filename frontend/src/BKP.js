...
export default function RoundList() {
  ...
  const [fieldPlayerOne, setFieldPlayerOne] = useState('');
  ...
  const Restart = () => {
    ...
    fetch(url, {
      ...
      (result) => {
        alert(result['Session has been restarded'])
      }
    )
              ...
              <Grid container spacing={2}>
                <Grid item>
                  <TextField
                    ...
                    id="firstName"
                    label="Player One"
                    value={fieldPlayerOne}
                    onChange={(e) => setFieldPlayerOne(e.target.value)}
                  />
                </Grid>
                <Grid item>
                  <TextField
